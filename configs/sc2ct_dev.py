import torch
from dataloader.dataloader_sc2ct import Sc2ct
...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.data_root = '/home/data3t/luxijun/document/SimSID-main/data'
        self.train_dataset = Sc2ct(
            # self.data_root+'/CellData/chest_xray/train',
            self.data_root+'/sc2ct/train',
            train=True,
        ...
        self.val_dataset = Sc2ct(
            # self.data_root+'/CellData/chest_xray/val',
            self.data_root+'/sc2ct/val',
            train=False,
            img_size=(self.img_size, self.img_size),
            normalize_tanh=self.normalize_tanh,
            full=True
        ...
        self.test_dataset = Sc2ct(
            # self.data_root+'/CellData/chest_xray/test',
            self.data_root+'/sc2ct/test',
            train=False,
            img_size=(self.img_size, self.img_size),
            normalize_tanh=self.normalize_tanh,
            full=True
